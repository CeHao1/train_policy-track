function track=standard_track(lean)
...
track.S=xx;
track.X=ppval(track.pX,track.t);
track.Y=ppval(track.pY,track.t);
track.Psi=ppval(track.pPsi,track.t);
track.Kap=ppval(track.pKap,track.t);
